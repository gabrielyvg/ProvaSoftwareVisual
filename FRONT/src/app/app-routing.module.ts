...
const routes: Routes = [ 
{path:"",component: ListarAutomovelComponent,},

{path:"automovel/listar", component: ListarAutomovelComponent,},

{path:"automovel/cadastrar", component: CadastrarAutomovelComponent,}];
